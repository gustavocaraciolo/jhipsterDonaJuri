...
import com.br.discovery.service.UserService;
import com.br.discovery.service.dto.UserDTO;
import com.br.discovery.service.mapper.UserMapper;
import com.br.discovery.web.rest.errors.ExceptionTranslator;
import com.br.discovery.web.rest.vm.ManagedUserVM;
...
public class UserResourceIntTest {
    ...
    public void getAllAuthorities() throws Exception {
        restUserMockMvc.perform(get("/api/users/authorities")
            ...
            .andExpect(jsonPath("$").value(containsInAnyOrder(AuthoritiesConstants.ADMIN, AuthoritiesConstants.ADVOGADO, AuthoritiesConstants.CLIENTE, AuthoritiesConstants.COORDENADOR, AuthoritiesConstants.USER)));
    }
