...
currentAccount: any;
    ...
    transition() {
        this.router.navigate(['/pendencia'], {queryParams:
            {
                page: this.page,
                size: this.itemsPerPage,
    ...
    trackId(index: number, item: Pendencia) {
        return item.id;
    }
    ...
    registerChangeInPendencias() {
        this.eventSubscriber = this.eventManager.subscribe('pendenciaListModification', (response) => this.loadAll());
    }
